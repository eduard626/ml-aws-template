...
def main():
    ...
    if not force:
        bootstrap_markers = ["src", "dvc.yaml", "requirements.txt", "setup.py"]
        ...
        if already_bootstrapped:
            ...
            print("   After bootstrap, you can freely edit requirements.txt and other files.")
            ...
            print("   - Edit requirements.txt directly, or")
            print("   - Edit .ml-aws-template/.projenrc.js and run: node .projenrc.js")
            sys.exit(0)
    ...
    # Fix requirements.txt comment (Projen generates it with incorrect instructions)
    # Note: After bootstrap, users can edit requirements.txt directly
    requirements_path = project_dir / "requirements.txt"
    if requirements_path.exists():
        print("   Fixing requirements.txt comment...")
        ...
        # Find and replace the Projen-generated comment
        new_comment = "# Python dependencies for this project.\n# You can edit this file directly to add/remove dependencies.\n# Alternatively, edit .ml-aws-template/.projenrc.js and run: node .projenrc.js\n"
        
        # Remove the old comment line(s) - Projen comment starts with '# ~~ Generated by projen'
        filtered_lines = []
        skip_next_empty = False
        for i, line in enumerate(lines):
            if line.strip().startswith('# ~~ Generated by projen'):
        ...
        content = new_comment + ''.join(filtered_lines)
        with open(requirements_path, 'w', encoding='utf-8') as f:
            f.write(content)
        print("      -> Updated requirements.txt comment")
